...
- [TV Remote](tvremote.md) - Broadlink RM mini 3 with codes and imitationremote control dashboard pages
- [Klipper](klipper.md) - Connect to klipper directly without hacs from homeassistant
- [PixelIt](pixelit.md) - A nice little low-res display for clocks and messages and how I've integrated it into klipper
